...
def write_pcd(data):
    ...
    filePath = str(now.strftime("%H%M%S")) + ".pcd"
...
def main():
    ...
    rospy.Subscriber("/l515/depth/pointcloud", PointCloud2, callback)
    rospy.wait_for_message("/l515/depth/pointcloud", PointCloud2)
